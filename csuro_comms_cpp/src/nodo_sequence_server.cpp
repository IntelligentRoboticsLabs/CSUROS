...
protected:
  ...
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<csuro_comms_cpp::SequenceAction> as_;
  std::string action_name_;

  csuro_comms_cpp::SequenceFeedback feedback_;
  csuro_comms_cpp::SequenceResult result_;
...
public:
  ...
  void executeCB(const csuro_comms_cpp::SequenceGoalConstPtr &goal)
  {
    ros::Rate r(10);
    bool success = true;
